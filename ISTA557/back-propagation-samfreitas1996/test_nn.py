...
def test_gradients():
    ...
    [[o11, o12],
     [o21, o22],
     [o31, o32],
     [o41, o42]] = o = [[s(x) for x in row] for row in oi]
    # print('\n given o')
    # print(np.array(o))
    [[do11, do12],
     [do21, do22],
    ...
    # print('hidden_to_output_gradient')
    # print(np.array(g1))
    # print('input_to_hidden_gradient')
    # print(np.array(g2))

    np.testing.assert_allclose(hidden_to_output_gradient, g1)

    np.testing.assert_allclose(input_to_hidden_gradient, g2)
